...
describe Admin::YearsController do
  ...
  # Year. As you add validations to Admin::Year, be sure to
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Admin::Year" do
        expect {
          post :create, :year => valid_attributes
      ...
      it "redirects to list" do
        post :create, :year => valid_attributes
        response.should redirect_to(admin_years_path)
      end
    end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested year" do
        ...
        # specifies that the Admin::Year created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Year.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, :id => year.id, :year => {'these' => 'params'}
      end

      it "assigns the requested year as @year" do
        year = Year.create! valid_attributes
        put :update, :id => year.id, :year => valid_attributes
        assigns(:year).should eq(year)
      end

      it "redirects to the years" do
        year = Year.create! valid_attributes
        put :update, :id => year.id, :year => valid_attributes
        response.should redirect_to(admin_years_path)
      end
    ...
    describe "with invalid params" do
      it "assigns the year as @year" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Year.any_instance.stub(:save).and_return(false)
        put :update, :id => year.id.to_s, :year => {}
        assigns(:year).should eq(year)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested year" do
      year = Year.create! valid_attributes
      expect {
        delete :destroy, :id => year.id.to_s
      }.to change(Year, :count).by(-1)
    end
    ...
    it "redirects to the years list" do
      year = Year.create! valid_attributes
      delete :destroy, :id => year.id.to_s
      response.should redirect_to(admin_years_url)
    end
  end
